...
# Visualising how discussion moves individual's answers
...
Now we show the average movement for two kinds of discussions: those where individual's answers became more accurate vs those where individual's answers became less accurate. The arrow thickness represents the number of dicussions in each category:
