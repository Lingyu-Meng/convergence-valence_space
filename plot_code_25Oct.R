...
## ----visualise for average movement, echo = FALSE--------------------------------------------------------------------------------
...
save_plot('figure_25Oct.jpg',I_Mer, ncol = 3)

## ----save script, eval = FALSE---------------------------------------------------------------------------------------------------
## knitr::purl(input = "plot_code.Rmd", output = "plot_code_25Oct.R",documentation = 1)
